        ...
        for image in images:
            ...
            if extension == 'webp':
                ...
                if pipe_opt != None and save_generation_data:
                    # Debug: log exact parameters string we're about to embed
                    try:
                        cstr(f"Embedding parameters metadata: {a111_params}").debug.print()
                    except Exception:
                        pass
...
NODE_NAME = 'Save Images [RvTools-X]'
