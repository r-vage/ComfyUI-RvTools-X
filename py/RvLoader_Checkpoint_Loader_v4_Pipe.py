...
class RvLoader_Checkpoint_Loader_v4_Pipe:
    def __init__(self):
        pass
    ...
    def execute(self, ckpt_name: str, unet_name: str, weight_dtype: str, clip_name1: str, clip_name2: str, clip_name3: str, clip_name4: str, clip_type_: str,
        ...
        model_obj = loaded_ckpt if load_unet_checkpoint else (loaded_ckpt[:3][0] if hasattr(loaded_ckpt, '__len__') and len(loaded_ckpt) >= 1 else loaded_ckpt)
        pipe = {
            "model": model_obj,
            "clip": loaded_clip,
            "vae": loaded_vae,
...
NODE_NAME = 'Checkpoint Loader v4 (Pipe) [RvTools-X]'
NODE_DESC = 'Checkpoint Loader v4 (Pipe)'

NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvLoader_Checkpoint_Loader_v4_Pipe
}
