...
SETTINGS_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'json', 'settings')
SUBJECT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'json', 'subject')
...
class RvText_RandomPrompt:
    ...
    def INPUT_TYPES(cls):
        required = {}
        # Scan both json/settings and json/subject for files matching 0_0Name.txt
        for folder in [SETTINGS_PATH, SUBJECT_PATH]:
...
NODE_NAME = 'Random Prompt by jice [RvTools-X]'
